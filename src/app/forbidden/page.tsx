          ...
          return (
                    <div className="min-h-screen flex items-center justify-center px-6 starfield" style={{ background: 'var(--color-orion-950)' }}>
                              <div className="text-center max-w-lg relative z-10 animate-fade-in">
                                        <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-64 h-64 rounded-full bg-amber-500/8 blur-[100px] pointer-events-none" />

                                        <div className="relative w-24 h-24 mx-auto mb-8">
                                                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-amber-500/20 to-amber-600/10 border border-amber-500/20" />
                                                  <div className="absolute inset-0 flex items-center justify-center">
                                                            <ShieldX className="w-10 h-10 text-amber-400" strokeWidth={1.2} />
                                                  </div>
                                        </div>

                                        <p className="text-sm font-semibold text-amber-400 tracking-widest uppercase mb-3">Error 403</p>
